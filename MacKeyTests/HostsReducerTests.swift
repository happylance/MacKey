...
class HostsReducerTests: XCTestCase {
    ...
    let initialState = HostsState(
        allHosts: [
            "h1": HostInfo(alias: "h1", host: "host1", user: "u1", password: "p1"),
            "h2": HostInfo(alias: "h2", host: "host2", user: "u2", password: "p2")
        ],
        latestHostAlias: "h1")
    
    func testAddHost() {
        let newHost = HostInfo(alias: "h3", host: "host3", user: "u3", password: "p3")
    ...
    func testRemoveHost() {
        let hostToRemove = HostInfo(alias: "h1", host: "host1", user: "u1", password: "p1")
    ...
    func testSelectHost() {
        let hostToSelect = HostInfo(alias: "h2", host: "host2", user: "u2", password: "p2")
    ...
    func testUpdateHostAliasChanged() {
        let oldHost = HostInfo(alias: "h1", host: "host1", user: "u1", password: "p1")
        let newHost = HostInfo(alias: "h3", host: "host3", user: "u3", password: "p3")
    ...
    func testUpdateHostAliasChangedNotSelected() {
        let oldHost = HostInfo(alias: "h2", host: "host2", user: "u2", password: "p2")
        let newHost = HostInfo(alias: "h3", host: "host3", user: "u3", password: "p3")
        let newState = HostsReducer.handleAction(UpdateHost(oldHost:oldHost, newHost:newHost), state: initialState)
    ...
    func testUpdateHostAliasNotChanged() {
        let oldHost = HostInfo(alias: "h1", host: "host1", user: "u1", password: "p1")
        let newHost = HostInfo(alias: "h1", host: "host3", user: "u3", password: "p3")
        let newState = HostsReducer.handleAction(UpdateHost(oldHost:oldHost, newHost:newHost), state: initialState)
